      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">
            ...
            {{ values ? 'Alterar Mercadinho' : 'Adicionar Mercadinho' }}
          </h5>
          ...
          <form @submit.prevent="handleSubmit">
            <div class="mb-3">
              ...
              <input
                ...
                v-model="form.nome"
                required
                placeholder="Digite o nome do mercadinho"
              />
            </div>
          </form>
        </div>
  ...
  methods: {
    async handleSubmit() {
      if (!this.form.nome.trim()) {
        alert('Por favor, preencha o nome do mercadinho.');
        return;
      }
      ...
      try {
        ...
        console.error('Erro ao salvar mercadinho:', error);
        alert('Erro ao salvar mercadinho. Tente novamente.');
      }
    },
    close() {
      this.$emit('update:dialog', false);
